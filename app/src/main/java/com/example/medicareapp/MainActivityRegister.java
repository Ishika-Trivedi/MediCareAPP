...
public class MainActivityRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(v -> {
            ...
            View focusedView = MainActivityRegister.this.getCurrentFocus();
            if (focusedView != null) {
            ...
            if (email.isEmpty() || password.isEmpty() || confPassword.isEmpty())
                ...
                firebaseAuth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(MainActivityRegister.this, task -> {
                            if (task.isSuccessful()) {
                                Toast.makeText(MainActivityRegister.this, "Registration successful. Logging in", Toast.LENGTH_LONG).show();
